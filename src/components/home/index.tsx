                ...
                <ContentBox>
                    ...
                    >
                            ...
                            <Box width="100%" className="shadowed centred" style={{ backgroundColor: "white", justifyContent: "space-evenly" }}>
                                ...
                                >
                                    ...
                                    <ListItem>
                                        ...
                                        <ListItemText primary={<Typography variant="h5">Date</Typography>} secondary={<Typography variant="h6">Saturday, September 9, 2023</Typography>} />
                                    </ListItem>
                                    <Divider variant="inset" component="li" />
                                    <ListItem>
                                        <ListItemAvatar>
                                        ...
                                        <ListItemText primary={<Typography variant="h5">Time</Typography>} secondary={<Typography variant="h6">3:30 PM</Typography>} />
                                    </ListItem>
                                    <Divider variant="inset" component="li" />
                                    <ListItem>
                                        <ListItemAvatar>
                                    ...
                                    <ListItem>
                                        ...
                                        <ListItemText primary={<Typography variant="h5">Ceremony</Typography>} secondary={<Typography variant="h6">This is an unplugged ceremony. We invite our guests to be fully present. Kindly switch off all phones and cameras and enjoy the special moment with us. We have hired amazing photographers and videographers to capture our special day. We promise to share the photos after!</Typography>} />
                                    </ListItem>
                                </List>
                            </Box>
                        </PasswordProtected>
                        ...
                        <div className="home-picture shadowed" style={{ width: "60%" }}>
                            <img alt="Venue animation" width="100%" src="/resources/img/animation_2.gif" className="css-1ago99h"></img>
                        </div>
